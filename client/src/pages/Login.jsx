...
export default function Login() {
  ...
  return (
    <>
      <Helmet>
  <title>Вход | MARK LIGHT LTD</title>
  <meta name="description" content="Вход в системата на MARK LIGHT LTD – достъп до вашия профил и поръчки." />
      </Helmet>
          ...
          <div>
            ...
            <div className="text-right mt-2">
              <Link to="/forgot-password" className="text-blue-600 dark:text-blue-400 text-sm hover:underline">
                {t('Забравена парола') || 'Забравена парола?'}
              </Link>
            </div>
          </div>
