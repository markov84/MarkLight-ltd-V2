...
export default function Admin() {
  ...
  useEffect(() => {
    if (!loading && (!user || !user.isAdmin)) {
      setError("Достъпът е разрешен само за администратори!");
    } else {
      setError("");
    }
  }, [user, loading]);
  ...
  if (targetPage > tp && page !== 1) setPage(1);
    } catch (e) {
      console.error(e);
      if (!isMounted.current) return;
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Header */}
  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-center text-center sm:text-center text-sm">
        <div>
        ...
        <button
          className="mt-4 sm:mt-0 px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors shadow sm:ml-8"
  ...
  <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 w-full max-w-6xl mx-auto">
  ...
  <div className="bg-white dark:bg-gray-800 p-3 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 w-full max-w-xs mx-auto">
      ...
      {/* Product Form */}
  <div className="bg-white dark:bg-gray-800 p-3 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 w-full mx-auto">
            ...
            <div className="flex flex-col min-w-0">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-48 px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                            ...
                            return imgs.map((img, idx) => (
                              <img
                                ...
                                onError={(e) => {
                                  ...
                                  e.currentTarget.src =
                                    "https://dummyimage.com/48x48/cccccc/000000.png&text=No+Image";
                                }}
                              />
                            ));
                          })()}
